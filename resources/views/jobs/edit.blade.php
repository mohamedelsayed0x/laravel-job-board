    ...
    <form method="POST" action="/jobs/{{ $job->id }}">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input id="title" type="text" name="title" autocomplete="title"
                                    placeholder="Shift Leader" required value="{{ old('title', $job->title) }}"
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                                <input id="salary" type="text" name="salary" placeholder="$60,000 Per Year"
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            ...
            <div class="flex item-center">
                <button form="delete-form" class="text-red-500 text-sm font-bold">Delate</button>
            </div>
