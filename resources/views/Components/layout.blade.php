    ...
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link type="button" onclick="alert('Menu clicked')">
                                    Menu
                                </x-nav-link>
                            </div>
                        </div>
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <el-dropdown class="relative ml-3">
                                <button
                                    ...
                                    <img src="{{ asset('images/listen_AhB_icon.ico') }}" alt=""
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                ...
                <div class="border-t border-white/10 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Mohamed Elsayed</div>
                            <div class="text-sm font-medium text-gray-400">moelsayed0x@gmail.com</div>
                        </div>
                        <button type="button"
        ...
        <header class="relative bg-white shadow-sm">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
                ...
                <x-button href="/jobs/create">Greate Job</x-button>
            </div>
        </header>
        <main>
